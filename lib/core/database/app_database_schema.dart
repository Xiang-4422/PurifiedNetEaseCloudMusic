...
class AppDatabaseSchema {
  ...
  /// 播放恢复快照集合说明。
  static const DatabaseCollectionSchema playbackRestoreSnapshots = DatabaseCollectionSchema(
  ...
  /// 本地资源索引集合说明。
  static const DatabaseCollectionSchema localResourceEntries = DatabaseCollectionSchema(
  ...
  /// 用户作用域缓存集合说明。
  static const DatabaseCollectionSchema userScopedCache = DatabaseCollectionSchema(
  ...
  /// 应用通用缓存集合说明。
  static const DatabaseCollectionSchema appCacheEntries = DatabaseCollectionSchema(
