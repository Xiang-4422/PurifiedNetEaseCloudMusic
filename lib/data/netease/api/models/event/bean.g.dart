...
EventItem _$EventItemFromJson(Map<String, dynamic> json) => EventItem()
  ...
  ..showTime = (json['showTime'] as num?)?.toInt()
  ..forwardCount = (json['forwardCount'] as num?)?.toInt()
  ..sic = (json['sic'] as num?)?.toInt()
  ..insiteForwardCount = (json['insiteForwardCount'] as num).toInt()
  ..topEvent = json['topEvent'] as bool?
  ..user = NeteaseAccountProfile.fromJson(json['user'] as Map<String, dynamic>)
...
HugComment _$HugCommentFromJson(Map<String, dynamic> json) => HugComment()
  ..user = NeteaseUserInfo.fromJson(json['user'] as Map<String, dynamic>)
...
TopicContent _$TopicContentFromJson(Map<String, dynamic> json) => TopicContent()
  ..id = dynamicToString(json['id'])
  ..type = (json['type'] as num?)?.toInt()
  ..content = json['content'] as String?;
...
Topic _$TopicFromJson(Map<String, dynamic> json) => Topic()
  ...
  ..headPic = (json['headPic'] as num?)?.toInt()
  ..status = (json['status'] as num?)?.toInt()
  ...
  ..rectanglePic = (json['rectanglePic'] as num?)?.toInt()
...
TopicItem2 _$TopicItem2FromJson(Map<String, dynamic> json) => TopicItem2()
  ..id = dynamicToString(json['id'])
...
TopicItem _$TopicItemFromJson(Map<String, dynamic> json) => TopicItem()
  ...
  ..participateCount = (json['participateCount'] as num?)?.toInt()
  ...
  ..topicType = (json['topicType'] as num?)?.toInt()
  ..meetingBeginTime = (json['meetingBeginTime'] as num?)?.toInt()
  ..meetingEndTime = (json['meetingEndTime'] as num?)?.toInt()
...
CommentWrap _$CommentWrapFromJson(Map<String, dynamic> json) => CommentWrap()
  ..code = dynamicToInt(json['code'])
  ..message = json['message'] as String?
  ..msg = json['msg'] as String?
...
MsgPromotion _$MsgPromotionFromJson(Map<String, dynamic> json) => MsgPromotion()
  ..id = dynamicToString(json['id'])
  ..title = json['title'] as String?
  ..coverUrl = json['coverUrl'] as String?
...
MsgGeneral _$MsgGeneralFromJson(Map<String, dynamic> json) => MsgGeneral()
  ..title = json['title'] as String?
...
Talk _$TalkFromJson(Map<String, dynamic> json) => Talk()
  ...
  ..status = (json['status'] as num?)?.toInt()
  ..mlogCount = (json['mlogCount'] as num?)?.toInt()
  ..follows = (json['follows'] as num?)?.toInt()
  ..participations = (json['participations'] as num?)?.toInt()
  ..showParticipations = (json['showParticipations'] as num?)?.toInt()
...
MyLog _$MyLogFromJson(Map<String, dynamic> json) => MyLog()
  ..id = dynamicToString(json['id'])
  ..type = (json['type'] as num?)?.toInt()
  ..resource = MyLogResource.fromJson(json['resource'] as Map<String, dynamic>)
  ..alg = json['alg'] as String?
  ..reason = json['reason'] as String?
  ..matchField = (json['matchField'] as num?)?.toInt()
