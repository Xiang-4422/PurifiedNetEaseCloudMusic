    ...
    return Obx(() {
      return Padding(
        ...
        child: Visibility(
          ...
          child: Listener(
            onPointerDown: (event) {
              controller.isLyricsMoving.value = true;
              //记录手指放下的y位置
            ...
            onPointerUp: (event) {
              ...
              Future.delayed(const Duration(milliseconds: 2500), () => controller.isLyricsMoving.value = false);
            },
            child: ClickableListWheelScrollView(
              itemHeight: controller.hasTransLyrics.value ? 210.w : 90.w,
              ...
              child: ListWheelScrollView.useDelegate(
                itemExtent: controller.hasTransLyrics.value ?  210.w : 120.w,
                ...
                childDelegate: ListWheelChildBuilderDelegate(
                  builder: (context, index) => Container(
                    width: context.width,
                    height: controller.hasTransLyrics.value ? 220.w : 120.w,
                    ...
                    child: Column(
                      ...
                      children: [
                        Obx(() => Text(
                          ...
                          style: TextStyle(fontSize: controller.hasTransLyrics.value ? 34.sp : 36.sp, color: controller.landscape?Theme.of(context).cardColor.withOpacity(controller.currLyricIndex.value == index?0.8:.4):controller.bodyColor.value.withOpacity(controller.currLyricIndex.value == index?0.8:.4)),
                          textAlign: TextAlign.center,
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                        )),
                        Visibility(
                          visible: controller.hasTransLyrics.value,
